...
<div class="bg-white pt-40 pb-12 px-4">
	<div class="max-w-6xl mx-auto">
		...
		<div class="grid md:grid-cols-2 gap-8">
			...
			<div class="contact-info-card rounded-lg p-8 shadow-lg">
				<h2 class="text-2xl font-bold mb-6">ÉLOGE DU MONDE</h2>
				<p class="mb-8 text-lg">Créateurs de voyages personnalisés</p>
				
				<div class="space-y-6">
					<div class="flex items-start gap-4">
						<div class="contact-icon rounded-full p-3">
				...
				<div class="mt-10 pt-8 border-t contact-divider">
					<p class="italic">
				...
				<form action="<?= base_url('contact/send') ?>" method="post" class="space-y-4">
					<div>
						...
						<input 
							...
							name="name" 
							required
							class="w-full px-4 py-2 border border-gray-300 rounded-md contact-input"
					...
					<div class="pt-4">
						<button 
							type="submit" 
								class="w-full text-white font-semibold py-3 px-6 rounded-md transition-colors flex items-center justify-center gap-2 contact-button"
						>
