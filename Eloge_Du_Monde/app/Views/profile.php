	...
	<div class="max-w-2xl mx-auto">
		...
		<div class="bg-white border border-gray-200 rounded-lg p-6">
			...
			<div class="flex gap-4 mt-8">
				<button type="button" id="btn-modifier" class="flex-1 flex items-center justify-center gap-2 button_modify hover:bg-amber-600 text-white font-medium py-3 px-6 rounded-md transition-colors">
