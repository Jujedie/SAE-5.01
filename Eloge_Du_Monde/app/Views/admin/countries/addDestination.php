...
<?= $this->section('title') ?>Ajouter une destination<?= $this->endSection() ?>
...
<div class="container mx-auto px-4 py-8">
	<div class="mb-8" style="margin-top:6rem;">
		...
		<h1 class="text-3xl font-bold text-gray-800">Ajouter une destination</h1>
	</div>
	...
	<div class="bg-white rounded-lg shadow-md p-8">
		<form action="<?= base_url('admin/countries/' . $country['idCountry'] . '/destinations/add') ?>" method="POST">
			<?= csrf_field() ?>
