		...
		<form action="<?= base_url('admin/prebuiltTrips/edit/' . $prebuiltTrip['idTrip']) ?>" method="POST" enctype="multipart/form-data">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div class="md:col-span-2 border-t pt-6 mt-4">
					...
					<p id="noStepsMessage" class="text-gray-500 text-sm italic py-4 text-center border-2 border-dashed border-gray-300 rounded-lg" style="<?= !empty($existingHosts) ? 'display:none;' : '' ?>">
...
<script>
	...
	const existingHosts = <?= json_encode($existingHosts ?? [], JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) ?>;
