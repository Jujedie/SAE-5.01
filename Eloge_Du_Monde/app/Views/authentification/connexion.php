		...
		<div class="bg-white rounded-lg shadow border border-gray-300">
			<div class="p-6">
				...
				<div class="text-center mt-4">
					<a href="<?= site_url('oublieMdp') ?>" class="text-sm text-gray-600 hover:underline">Mot de passe oublié ?</a>
				</div>
				<div class="text-center mt-3">
					<a href="<?= site_url('inscription') ?>" class="text-sm text-gray-600 hover:underline">Créer un compte</a>
				</div>
			</div>
		</div>
	</div>
